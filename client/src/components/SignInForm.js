...
class SignInForm extends Component {
  ...
  render() {
    ...
    return (
      <div className="container" style={{minHeight: '500px' , marginTop: '50px'}}>
      <form className="col-md-8 col-md-offset-1" onSubmit={handleSubmit(this.props.signInUser.bind(this))}>

        <div className={`form-group ${username.touched && username.invalid ? 'has-error' : ''}`}>
          <label className="control-label">@username*</label>
          <input  placeholder="@tks" type="text" className="form-control" {...username} />
